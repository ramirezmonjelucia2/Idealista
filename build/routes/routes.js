...
class DatoRoutes {
    constructor() {
        ...
        this.postVivienda = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { _tipoObjeto, _idVivienda, _largo, _ancho, municipio, ciudad, codpost, habitaciones, baños, ascensor, _piscina, _largojardin, _anchojardin, _cochera } = req.body; //!!!!!!!!!!!!!!!!!!!!!!!!!req.body no req.param
            yield database_1.db.conectarBD();
            let dSchemaViv = {
